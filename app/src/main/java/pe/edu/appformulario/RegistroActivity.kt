...
import pe.edu.appformulario.databinding.ActivityRegistroBinding
import pe.edu.appformulario.util.AppMensaje
import pe.edu.appformulario.util.TipoMensaje
...
class RegistroActivity : AppCompatActivity(), View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private fun irListadoPersonas() {
        var intentListado = Intent(applicationContext,
            ...
            putExtra("listaPersona", listaPersonas)
        }
